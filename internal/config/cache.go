...
type Cache struct {
	...
	ChoiceKeyFormat        string `env:"CONSUMER_SUPERHERO_CHOICE_REDIS_CHOICE_KEY_FORMAT" yaml:"choice_key_format" default:"choice.%s.%s"`
	LikesKeyFormat         string `env:"CONSUMER_SUPERHERO_CHOICE_REDIS_LIKES_KEY_FORMAT" yaml:"likes_key_format" default:"likes.for.%s"`
}
